...
import com.challenge.tweetsviewerapp.databinding.TweetLinkBinding
...
class LinkViewHolder(
    ...
    fun bind(item: Tweet) {
        ...
        binding.cvTweetLinkItem.setOnClickListener {
            iItemClickListener.onItemClick(item,Constants.LINK)
        }
