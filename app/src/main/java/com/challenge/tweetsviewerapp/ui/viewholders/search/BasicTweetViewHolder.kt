...
import com.challenge.tweetsviewerapp.databinding.TweetBasicBinding
...
class BasicTweetViewHolder(
    var binding: TweetBasicBinding,
    ...
    fun bind(item: Tweet) {
        ...
        binding.cvTweetBasicItem.setOnClickListener {
